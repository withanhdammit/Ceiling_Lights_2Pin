...
#define W_COLOR_WEIGHT_PRESET 4   //What color weighting to choose
...
byte allowedcolors[6][3] ={
  ...
  {  17, 177,  13 },   //11B10D Yellow Green Color Wheel
  {  25, 173, 121 },   //19AD79 Green Crayola
  {   3,  50,  32 },   //033220 Dark Green
  {   2,   7,  93 },   //02075D Dark Navy
  {  84,  30,  27 },   //541E1B Dark Red
...
byte colorweighting[4][6] = {
  ...
  { 10, 10, 10,  4,  5,  5 }    //Weighting green, blue/purple/red less
};
