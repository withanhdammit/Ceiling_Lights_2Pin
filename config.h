...
#define NUM_LEDS_PER_STRIP      600      // number of LEDs in your strip
...
#define MQTT_GROUP_TOPIC "cmnd/Ceiling-test2" // MQTT group topic set to your own choice of group or remove if not wanted
